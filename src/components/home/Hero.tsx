      ...
      <div className="min-h-screen pb-20">
        ...
        <nav className="z-50 flex items-center justify-between w-full py-4 px-6 md:px-16 lg:px-24 xl:px-40 text-sm">
          ...
          <div className="flex gap-2">
            <Button
              className="hidden md:block px-6 py-2 active:scale-95 transition-all rounded-full text-white cursor-pointer"
            >
              Sign Up
            </Button>
            <Button
              className="cursor-pointer hidden md:block px-6 py-2 border active:scale-95 hover:bg-slate-50 transition-all rounded-full text-slate-700 hover:text-slate-900 bg-trasparent"
            >
              Login
            </Button>
          </div>
        ...
        <div className="relative flex flex-col items-center justify-center text-sm px-4 md:px-16 lg:px-24 xl:px-40 text-black">
          ...
          {/* Headline + CTA */}
          <h1 className="mt-24 text-5xl md:text-6xl font-semibold max-w-5xl text-center md:leading-[70px]">
          ...
          <p className="max-w-md text-center text-base my-7">
           Whether you’re just observing the crypto market or meticulously tracking your holdings — CryptoPulse Portfolio is tailored to meet your needs.
          </p>
